...
$HOME/opt/cross/bin/x86_64-elf-g++ -Ttext=0x7E00 -ekmain -nostdlib -lgcc build/kmain.o build/video.o build/assertions.o build/print.o build/mem.o build/stdlib.o build/interrupts.o -o build/kernel.elf
